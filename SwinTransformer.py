...
selected_labels = ['Cardiomegaly', 'Emphysema', 'Effusion', 'Hernia', 'Infiltration', 'Mass', 'Nodule', 'Atelectasis',
...
def create_label_subset(df, labels, num_samples=500):
    subsets = []
    for label in labels:
...
# Define custom dataset for Swin
